		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="${pageContext.request.contextPath}/document/updateDocument.action" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
						...
						<tr><td class="font3 fftd">文档描述：<br/>
							<textarea name="pemark" cols="88" rows="11" id="content">${document.pemark }</textarea>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
