...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/employee/updateEmployee.action" id="employeeForm" method="post">
			<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    	...
		    	<table>
		    		...
		    		<tr>
		    			<td class="font3 fftd">性别：
								<select id="sex" name="sex1" style="width:143px;">
			...
			<tr>
				<td class="font3 fftd">
					备&nbsp;&nbsp;&nbsp;&nbsp;注：<input name="pemark" id="remark" size="40" value="${employee.pemark }"/>
					&nbsp;&nbsp;所属部门：
