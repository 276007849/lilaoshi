    ...
    <td>
    	 <form action="${pageContext.request.contextPath}/employee/addEmployee.action" id="employeeForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    	...
		    	<table>
		    		...
		    		<tr>
		    			<td class="font3 fftd">性别：
									<select name="sex1" style="width:143px;">
		    			...
		    			<td class="font3 fftd">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：
		    			 <select name="job_id" style="width:143px;">
					    			...
					    			<c:forEach items="${requestScope.jobs1 }" var="job">
			...
			<tr>
				<td class="font3 fftd">
					备&nbsp;&nbsp;&nbsp;&nbsp;注：<input name="pemark" id="remark" size="40"/>
					&nbsp;&nbsp;所属部门：
					<select  name="dept_id" style="width:100px;">
						   <option value="0">--部门选择--</option>
						   <c:forEach items="${requestScope.depts1 }" var="dept">
